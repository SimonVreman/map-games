...
def write_brazil():
    ...
    output = open_utf8("output/brazil.path.txt", "w")
    boundaries, _ = read_boundaries(df)
...
def write_brazil_first_administrative():
    ...
    output = open_utf8("output/brazil-first-administrative.path.txt", "w")
...
def write_brazil_phone():
    ...
    for key, ddd in ddds.items():
        ...
        normalized_ddd_2_cities = (
            set(map(normalize_string, ddd["adm2_2"])) if "adm1_2" in ddd else set()
        )
