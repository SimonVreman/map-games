...
// @license
//   MIT License
export function polyfillPathData(window) {
  ...
  let isPathDataSupported =
    window.SVGPathElement.prototype.getPathData !== undefined &&
    window.SVGPathElement.prototype.setPathData !== undefined;
  ...
  if (isPathDataSupported === false) {
    ...
    var setAttributeNS = window.SVGPathElement.prototype.setAttributeNS;
    var removeAttribute = window.SVGPathElement.prototype.removeAttribute;
    var removeAttributeNS = window.SVGPathElement.prototype.removeAttributeNS;
    ...
    window.SVGPathElement.prototype.setAttributeNS = function (
      namespace,
      name,
      value
    ) {
    ...
    window.SVGPathElement.prototype.removeAttributeNS = function (
      namespace,
      name
    ) {
      if (name === "d") {
  ...
  if (!window.SVGRectElement.prototype.getPathData) {
  ...
  if (!window.SVGCircleElement.prototype.getPathData) {
  ...
  if (!window.SVGEllipseElement.prototype.getPathData) {
  ...
  if (!window.SVGLineElement.prototype.getPathData) {
  ...
  if (!window.SVGPolylineElement.prototype.getPathData) {
  ...
  if (!window.SVGPolygonElement.prototype.getPathData) {
