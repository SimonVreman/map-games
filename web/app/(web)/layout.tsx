import { BriefcaseBusinessIcon, GithubIcon, HeartIcon } from "lucide-react";

export default function WebLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="w-full text-muted-foreground text-center py-2 text-sm hover:text-primary transition-all bg-muted">
        <a href="https://simonvreman.nl/work" target="_blank">
          <BriefcaseBusinessIcon className="inline size-4 -mt-0.5 mr-2" />
          Considering new work opportunities, feel free to reach out!
        </a>
      </div>
